...
-- -----------------------------------------------------
CREATE TABLE
IF NOT EXISTS `coquitaDB`.`profiles`
(
...
-- -----------------------------------------------------
CREATE TABLE
IF NOT EXISTS `coquitaDB`.`carts`
(
  `id` INT NOT NULL AUTO_INCREMENT,
  `user_id` INT NULL DEFAULT NULL,
  PRIMARY KEY
(`id`),
  INDEX `fk_carts_1_idx`
(`user_id` ASC),
  CONSTRAINT `fk_carts_1`
    FOREIGN KEY
(`user_id`)
    REFERENCES `coquitaDB`.`users`
(`id`))
ENGINE = InnoDB;
...
-- -----------------------------------------------------
CREATE TABLE
IF NOT EXISTS `coquitaDB`.`categories`
(
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR
(100) NOT NULL,
...
-- -----------------------------------------------------
CREATE TABLE
IF NOT EXISTS `coquitaDB`.`products`
(
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR
(100) NOT NULL,
...
-- -----------------------------------------------------
CREATE TABLE
IF NOT EXISTS `coquitaDB`.`cart_items`
(
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY
(`id`),
  INDEX `fk_cart_items_1_idx`
(`cart_id` ASC),
  INDEX `fk_cart_items_2_idx`
(`product_id` ASC),
  CONSTRAINT `fk_cart_items_1`
    FOREIGN KEY
(`cart_id`)
    REFERENCES `coquitaDB`.`carts`
(`id`),
  CONSTRAINT `fk_cart_items_2`
    FOREIGN KEY
(`product_id`)
    REFERENCES `coquitaDB`.`products`
(`id`))
ENGINE = InnoDB;
